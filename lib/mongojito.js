...
Mongojito.connect = function(servers, logger) {
  ...
  this.DB = Client = new mongolian(servers[0]);
  if (logger)
    Client.log = {
...
Mongojito.model = function(modelname) {
  return models[modelname] || Mongojito.bake.call(this, Array.prototype.slice(arguments));
}
